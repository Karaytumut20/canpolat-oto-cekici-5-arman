...
export function SeoDirectory({ eyebrow, title, intro, groups }: { eyebrow: string; title: string; intro: string; groups: Group[] }) {
  return <main className="directory-page">
    <header className="site-header area-header">
      ...
      <nav><Link href="/hizmetler">Hizmetler</Link><Link href="/hizmet-bolgeleri">Bölgeler</Link><Link href="/cekmekoy-oto-cekici">Çekmeköy</Link><Link href="/sancaktepe-oto-cekici">Sancaktepe</Link><Link href="/blog">Bilgi Merkezi</Link></nav>
